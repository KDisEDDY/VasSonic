 ...
 * @date 2018/6/3
 */
public class SonicQuicSessionStream extends InputStream {
    /**
     * Log filter
     */
     ...
     */
    private QuicBufferedInputStream netStream;
     ...
     */
    public SonicQuicSessionStream(SonicSessionStream.Callback callback, ByteArrayOutputStream outputStream, QuicBufferedInputStream netStream) {
        if (null != netStream) {
        ...
        callbackWeakReference = new WeakReference<SonicSessionStream.Callback>(callback);
    }
    ...
    public void close() throws IOException {
        ...
        SonicSessionStream.Callback callback = callbackWeakReference.get();
        if (null != callback) {
